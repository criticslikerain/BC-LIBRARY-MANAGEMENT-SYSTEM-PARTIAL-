...
<head>
  ...
  <title>Edit Iussed Books | Library</title>
...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('issuedBooks.update', $issuedBook->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="book_id">Book</label>
                <input type="text" name="book_id" id="book_id" value="{{ $issuedBook->book_id }}" class="form-control">
            </div>
            <div class="form-group">
                <label for="student_id">Student</label>
                <input type="text" name="student_id" id="student_id" value="{{ $issuedBook->student_id }}" class="form-control">
            </div>
