...
<head>
  ...
  <title>Manage Issued Books | Library</title>
                          ...
                          <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                  ...
                                  <tbody>
                                      @php
                                          $books = [
                                              (object) ['BookName' => 'Book 1', 'CategoryName' => 'Fiction', 'AuthorName' => 'Author A', 'ISBNNumber' => '123456789', 'BookPrice' => '20', 'bookid' => 1],
                                              (object) ['BookName' => 'Book 2', 'CategoryName' => 'Non-Fiction', 'AuthorName' => 'Author B', 'ISBNNumber' => '987654321', 'BookPrice' => '25', 'bookid' => 2],
                                      ...
                                      @foreach($books as $book)
                                          <tr class="odd gradeX">
                                              ...
                                              <td class="center">{{ $book->CategoryName }}</td>
                                              <td class="center">{{ $book->AuthorName }}</td>
