              ...
              <div class="card-body">
                  <div class="table-responsive">
                      <table class="table table-striped table-bordered">
                          ...
                          <tbody>
                              @php
                                  // Temporary array simulating category data
                                  $categories = [
                                      ['id' => 1, 'CategoryName' => 'Romantic', 'Status' => 1, 'CreationDate' => '2023-01-01 12:00:00', 'UpdationDate' => '2023-01-02 12:00:00'],
                                      ['id' => 2, 'CategoryName' => 'Technology', 'Status' => 1, 'CreationDate' => '2023-01-03 14:00:00', 'UpdationDate' => '2023-01-04 15:00:00'],
                                      ['id' => 3, 'CategoryName' => 'Science', 'Status' => 1, 'CreationDate' => '2023-02-01 08:30:00', 'UpdationDate' => '2023-02-02 09:00:00'],
                                      ['id' => 4, 'CategoryName' => 'Management', 'Status' => 0, 'CreationDate' => '2023-03-01 10:00:00', 'UpdationDate' => '2023-03-02 11:00:00'],
                                      ['id' => 5, 'CategoryName' => 'Literary Fiction', 'Status' => 1, 'CreationDate' => '2023-04-01 16:45:00', 'UpdationDate' => '2023-04-02 18:20:00'],
                                  ];
                              @endphp
                              ...
                              @foreach ($categories as $index => $category)
                                  <tr class="odd gradeX">
                                      ...
                                      <td class="center">{{ $category['CreationDate'] }}</td>
                                      <td class="center">{{ $category['UpdationDate'] }}</td>
                                      <td class="center">
                                          <a href="">
